...
document.addEventListener("click", function (event) {
  console.log(_modal_search_modal_search__WEBPACK_IMPORTED_MODULE_1__.searchModal.classList.contains("main__search-modal--hidden"))
  console.log(event.target)
  if (!event.target.closest(".main__search-modal")&& !event.target.matches(".main__display-search-btn")  && (_modal_search_modal_search__WEBPACK_IMPORTED_MODULE_1__.searchModal.classList.contains("main__search-modal--hidden")== false)) {
    _modal_search_modal_search__WEBPACK_IMPORTED_MODULE_1__.searchModal.setAttribute("style", "animation-name : swing-out-left; animation-duration: 0.5s");
    setTimeout(hide, 500) 
  }   else if (!event.target.closest(".main__modal")&& !event.target.matches(".main__display-form-btn")  && (_modal_search_modal_search__WEBPACK_IMPORTED_MODULE_1__.searchModal.classList.contains("main__modal--hidden")== false)) {
    _modal_modal__WEBPACK_IMPORTED_MODULE_0__.modal.setAttribute("style", "animation-name : swirl-out-bck; animation-duration: 0.6s");
